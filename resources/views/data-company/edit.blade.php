...
<div class="flex flex-col gap-4 bg-white w-full rounded-2xl p-4">
    ...
    <form action="{{ route('data-company.update', $company->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="flex flex-col gap-2">
                ...
                @if($company->company_logo)
                    <div class="mb-2">
                        <img src="{{ Storage::url($company->company_logo) }}" alt="Current Logo" class="h-40  object-cover rounded">
                    </div>
                @endif
