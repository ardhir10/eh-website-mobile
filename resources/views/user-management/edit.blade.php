        ...
        <div class="bg-white rounded-lg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        @error('password')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                        <p class="text-xs text-gray-500">Leave blank to keep current password. New password must be at least 6 characters and contain both letters and numbers.</p>
                    </div>
            ...
            <div class="mb-6">
                ...
                <div class="flex flex-col gap-2">
                    @if($user->avatar)
                        <div class="mb-2">
                            <img src="{{ Storage::url($user->avatar) }}" alt="Current avatar" class="w-24 h-24 rounded-lg object-cover">
                            <p class="text-sm text-gray-500 mt-1">Current avatar</p>
                        </div>
                    @endif
                    <label for="avatar" class="text-sm font-medium text-gray-700">New Avatar</label>
                    <input type="file" name="avatar" id="avatar" 
                        ...
                        accept="image/*">
                    <p class="text-xs text-gray-500">Leave blank to keep current avatar. Accepted formats: JPG, JPEG, PNG. Max size: 2MB</p>
                    @error('avatar')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
